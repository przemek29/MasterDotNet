...
namespace Sensors
{
    public class Giroskop : KalibracjaBias
    {
        ...
        public void obliczKaty(double czestotliwoscProbkowania)
        {

            euler = _calkaTrapeza.calkuj(omegaKal, 1 / czestotliwoscProbkowania);
