...
{
    public class FiltrMadgwicka
    {




        double beta = 0.01;                                                         // 2 * proportional gain (Kp)
        public double[] quaternion { get; set; }



        public void MadgwickAHRSupdate(double[] quaternion, double sampleFreq, double ax, double ay, double az, double gx, double gy, double gz, double mx, double my, double mz)
        {
        ...
        public void MadgwickAHRSupdateIMU(double[] quaternion, double sampleFreq,
